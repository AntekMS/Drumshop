...
<div class="container py-5">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <p class="fw-bold">Stand: <?= date('d.m.Y') ?></p>

            <h2 class="h4 mt-4">1. Verantwortliche Stelle</h2>
            ...
            <h2 class="h4 mt-4">2. Grundlegendes</h2>
            <p>Diese Datenschutzerklärung soll die Nutzer dieser Website gemäß Datenschutz-Grundverordnung (DSGVO) über die Art, den Umfang und den Zweck der Erhebung und Verwendung personenbezogener Daten durch den Websitebetreiber DrumShop GmbH informieren.</p>
            <p>Wir nehmen Ihren Datenschutz sehr ernst und behandeln Ihre personenbezogenen Daten vertraulich und entsprechend der gesetzlichen Vorschriften. Bedenken Sie, dass die Datenübertragung im Internet grundsätzlich mit Sicherheitslücken verbunden sein kann. Ein vollständiger Schutz vor dem Zugriff durch Fremde ist nicht realisierbar.</p>

            <h2 class="h4 mt-4">3. Zugriffsdaten</h2>
            <p>Wir erheben Daten über Zugriffe auf die Website und speichern diese als „Server-Logfiles" ab. Folgende Daten werden protokolliert:</p>
            <ul>
            ...
            <h2 class="h4 mt-4">5. Umgang mit Kontaktdaten</h2>
            ...
            <h2 class="h4 mt-4">6. Umgang mit Kommentaren und Beiträgen</h2>
            <p>Hinterlassen Sie auf dieser Website einen Beitrag oder Kommentar, werden Ihre IP-Adresse gespeichert. Dies dient der Sicherheit des Websitebetreibers: Sollte Ihr Text gegen geltendes Recht verstoßen, können wir dafür belangt werden, weshalb wir ein Interesse an der Identität des Kommentar- bzw. Beitragsautors haben.</p>

            <h2 class="h4 mt-4">7. Google Analytics</h2>
            ...
            <p>Weiterhin können Sie durch ein Browser-Plugin verhindern, dass die durch Cookies gesammelten Informationen (inklusive Ihrer IP-Adresse) an die Google Inc. gesendet und von der Google Inc. genutzt werden. Folgender Link führt Sie zu dem entsprechenden Plugin: <a href="https://tools.google.com/dlpage/gaoptout" target="_blank">https://tools.google.com/dlpage/gaoptout</a></p>
            <p>Alternativ klicken Sie auf diesen Link, um die Erfassung durch Google Analytics auf dieser Website zukünftig zu verhindern. Dabei wird ein Opt-Out-Cookie auf Ihrem Endgerät abgelegt. Löschen Sie Ihre Cookies, müssen Sie diesen Link erneut klicken.</p>

            <h2 class="h4 mt-4">8. Nutzung von Social-Media-Plug-ins</h2>
            <p>Diese Website verwendet Facebook Social Plugins, die von der Facebook Inc. (1 Hacker Way, Menlo Park, California 94025, USA) betrieben werden. Erkennbar sind die Einbindungen an dem Facebook-Logo bzw. an den Begriffen „Like", „Gefällt mir", „Teilen" auf dieser Website. Eine Übersicht über die Facebook Social Plugins finden Sie hier: <a href="https://developers.facebook.com/docs/plugins/" target="_blank">https://developers.facebook.com/docs/plugins/</a></p>
            <p>Wenn Sie diese Website besuchen, wird über das Plugin eine direkte Verbindung zwischen Ihrem Browser und dem Facebook-Server hergestellt. Facebook erhält dadurch die Information, dass Sie mit Ihrer IP-Adresse diese Website besucht haben. Wenn Sie den Facebook „Like-Button" anklicken, während Sie in Ihrem Facebook-Account eingeloggt sind, können Sie die Inhalte dieser Website auf Ihrem Facebook-Profil verlinken. Dadurch kann Facebook den Besuch dieser Website Ihrem Benutzerkonto zuordnen. Der Websitebetreiber hat keinen Einfluss auf die Weitergabe dieser Daten an Facebook. Weitere Informationen hierzu finden Sie in der Datenschutzerklärung von Facebook unter: <a href="https://de-de.facebook.com/policy.php" target="_blank">https://de-de.facebook.com/policy.php</a></p>
            ...
            <h2 class="h4 mt-4">9. Newsletter</h2>
            ...
            <h2 class="h4 mt-4">10. Rechte des Nutzers</h2>
            ...
            <h2 class="h4 mt-4">11. Löschung von Daten</h2>
            ...
            <h2 class="h4 mt-4">12. Widerspruchsrecht</h2>
            ...
            <p>Wenn Sie eine Berichtigung, Sperrung, Löschung oder Auskunft über die zu Ihrer Person gespeicherten personenbezogenen Daten wünschen oder Fragen bezüglich der Erhebung, Verarbeitung oder Verwendung Ihrer personenbezogenen Daten haben oder erteilte Einwilligungen widerrufen möchten, wenden Sie sich bitte an folgende E-Mail-Adresse: <a href="mailto:datenschutz@drumshop.de">datenschutz@drumshop.de</a></p>
        </div>
    </div>
</div>